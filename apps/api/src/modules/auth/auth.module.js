            ...
            imports: [
                ...
                jwt_1.JwtModule.registerAsync({
                    ...
                    useFactory: function (config) {
                        var _a, _b;
                        return ({
                            secret: (_a = config.get("JWT_ACCESS_SECRET")) !== null && _a !== void 0 ? _a : "dev_access_secret",
                            signOptions: { expiresIn: Number((_b = config.get("JWT_ACCESS_TTL_SECONDS")) !== null && _b !== void 0 ? _b : 900) }
                        });
                    }
                })
            ],
