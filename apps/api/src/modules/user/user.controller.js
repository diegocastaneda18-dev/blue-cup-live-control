...
var UserController = function () {
    var _classDecorators = [(0, common_1.Controller)("users"), (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard)];
    ...
    var UserController = _classThis = /** @class */ (function () {
        function UserController_1(users) {
            this.users = (__runInitializers(this, _instanceExtraInitializers), users);
        }
        UserController_1.prototype.list = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.users.listUsers()];
                });
            });
        };
    ...
    (function () {
        ...
        _list_decorators = [(0, common_1.Get)(), (0, roles_decorator_1.Roles)("admin")];
