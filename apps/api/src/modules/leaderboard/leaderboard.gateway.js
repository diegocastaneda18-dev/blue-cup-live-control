...
var LeaderboardGateway = function () {
    ...
    var LeaderboardGateway = _classThis = /** @class */ (function () {
        function LeaderboardGateway_1() {
            this.server = __runInitializers(this, _server_initializers, void 0);
            __runInitializers(this, _server_extraInitializers);
        }
        LeaderboardGateway_1.prototype.broadcastLeaderboardRefresh = function (tournamentId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.server.emit("leaderboard.refresh", { tournamentId: tournamentId });
                    return [2 /*return*/];
                });
            });
        };
        LeaderboardGateway_1.prototype.broadcastCatchEvent = function (tournamentId, payload) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.server.emit("catch.event", __assign({ tournamentId: tournamentId }, payload));
                    return [2 /*return*/];
                });
            });
        };
        return LeaderboardGateway_1;
    }());
    __setFunctionName(_classThis, "LeaderboardGateway");
    (function () {
        ...
        LeaderboardGateway = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return LeaderboardGateway = _classThis;
}();
