    ...
    var AuditService = _classThis = /** @class */ (function () {
        ...
        AuditService_1.prototype.log = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                var ctx, action, entity, entityId, meta;
                var _a, _b, _c;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ctx = params.ctx, action = params.action, entity = params.entity, entityId = params.entityId, meta = params.meta;
                            return [4 /*yield*/, this.prisma.auditLog.create({
                                    data: {
                                        actorId: (_a = ctx === null || ctx === void 0 ? void 0 : ctx.actorId) !== null && _a !== void 0 ? _a : null,
                                        action: action,
                                        entity: entity,
                                        ...
                                        userAgent: (_c = ctx === null || ctx === void 0 ? void 0 : ctx.userAgent) !== null && _c !== void 0 ? _c : null
                                    }
                                })];
                        case 1:
                            _d.sent();
