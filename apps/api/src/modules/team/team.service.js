...
var TeamService = function () {
    ...
    var TeamService = _classThis = /** @class */ (function () {
        function TeamService_1(prisma, audit) {
            this.prisma = prisma;
            this.audit = audit;
        }
        TeamService_1.prototype.listByTournament = function (tournamentId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.team.findMany({
        ...
        TeamService_1.prototype.create = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                var team;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.team.create({
        ...
        TeamService_1.prototype.upsertBoat = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                var existingTeam, boat;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.team.findUnique({ where: { id: params.teamId } })];
                        case 1:
                            existingTeam = _a.sent();
                            if (!existingTeam)
                                throw new common_1.NotFoundException("Team not found");
                            return [4 /*yield*/, this.prisma.boat.upsert({
                        ...
                        case 3:
                            _a.sent();
                            return [2 /*return*/, boat];
                    }
                });
            });
        };
        TeamService_1.prototype.getTeamDashboardByUser = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                var membership;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            membership = _a.sent();
                            if (!membership)
                                throw new common_1.NotFoundException("User has no team membership");
                            return [2 /*return*/, this.prisma.team.findUnique({
