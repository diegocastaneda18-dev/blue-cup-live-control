...
async function main() {
    ...
    const baseCatch = {
        tournamentId: tournament.id,
        categoryId: catRelease.id,
        type: client_1.CatchType.release,
    ...
    await prisma.catch.create({
        data: {
            ...
            status: client_1.CatchStatus.submitted,
            scorePreliminary: 0,
            scoreOfficial: 0,
    ...
    await prisma.catch.create({
        data: {
            ...
            status: client_1.CatchStatus.pending_review,
            scorePreliminary: 0,
            scoreOfficial: 0,
    ...
    await prisma.catch.create({
        data: {
            ...
            createdById: captain.id,
            speciesId: specDorado.id,
            status: client_1.CatchStatus.approved,
    ...
    await prisma.catch.create({
        data: {
            ...
            status: client_1.CatchStatus.rejected,
            scorePreliminary: 0,
            scoreOfficial: 0,
    ...
    await prisma.catch.create({
        data: {
            ...
            createdById: teamMember.id,
            speciesId: specTuna.id,
            status: client_1.CatchStatus.penalized,
            scorePreliminary: 0,
            scoreOfficial: 0,
    ...
    await prisma.catch.create({
        data: {
            ...
            categoryId: catWeigh.id,
            speciesId: specMarlin.id,
            type: client_1.CatchType.weigh_in,
            status: client_1.CatchStatus.official,
            scorePreliminary: 0,
            scoreOfficial: 310,
            weightKg: 142.5,
            lengthCm: 248,
    ...
    await prisma.catchReview.create({
        data: {
            ...
            action: client_1.ReviewAction.approve,
    ...
    await prisma.catchReview.create({
        data: {
            ...
            reviewerId: committeeUser.id,
            action: client_1.ReviewAction.reject,
    ...
    await prisma.catchReview.create({
        data: {
            ...
            reviewerId: committeeUser.id,
            action: client_1.ReviewAction.penalize,
    ...
    console.log("Seed completed", {
        ...
        password: "BlueCup123!",
        leaderboardHint: "Marlin Royale leads on official points; Azul Dorado has strong preliminary; Atún Brisa has rejected/penalized only."
    });
}
main()
